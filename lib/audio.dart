...
//   final String url;
//   PlayAudio({Key? key,required this.url}) :super(key: key);
//   @override
...
//       ByteData bytes = await rootBundle.load(widget.url); //load audio from assets
//       audiobytes =
...
//                     Container(
//                       child: Text(
//                         currentpostlabel, style: TextStyle(fontSize: 25),),
//                     ),
//
//                     Container(
//                         child: Slider(
...
//                                   int result = await player.playBytes(
//                                       audiobytes);
